...
namespace Volet.Infrastructure.Migrations
{
    ...
    [Migration("20260119152028_AddKycTables")]
    partial class AddKycTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Volet.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<bool>("IsAuthenticatorConfirmed")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Volet.Domain.Entities.KycDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Volet.Domain.Entities.KycSubmission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Volet.Domain.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Volet.Domain.Entities.KycDocument", b =>
                {
                    b.HasOne("Volet.Domain.Entities.KycSubmission", "KycSubmission")
                        .WithMany("Documents")
            ...
            modelBuilder.Entity("Volet.Domain.Entities.KycSubmission", b =>
                {
                    b.HasOne("Volet.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
